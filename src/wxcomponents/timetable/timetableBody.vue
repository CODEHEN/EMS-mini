  ...
  <view class="timetable-main text-gray" :style="[bgImageStyle]">
    ...
    <view class="timetable-body"
      ...
      <view class="timetable-body-right">
        <block v-for="(dayTimetable, weekIndex) in timetableList" :key="weekIndex">
          <block v-for="(dayItem, dayIndex) in dayTimetable" :key="dayIndex">
            <view class="timetable-item" :class="!dayItem.length ? 'blank' : ''"
              ...
              <view v-if="dayItem.length" class="timetable-item-content" :style="'height:232rpx;background-color:'
                +
